...
(async () => {
    ...
    console.log('');
    alunos.forEach((aluno) => console.log(aluno.nome, aluno.email));
    console.log('');

    // --->

    console.log('');
    console.log("Buscando aluno pela Primary Key");
    ...
    console.log('');
    console.log("Alterando dados do aluno")

    const aluno1 = await Aluno.findByPk(3);
    aluno1.email = "emailteste@gmail.com";
    await aluno1.save();
    console.log('');
    (await Aluno.findAll()).forEach((aluno) => console.log(aluno.nome, aluno.email));
    console.log('');

    // --->

    console.log('');
    console.log("Exclusão do Aluno");
